...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.murals.index') }}" class="btn btn-md btn-info" title="Adicionar novo registro">
...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.murals.store') }}" autocomplete="off" onsubmit="return mySubmit()" autocomplete="off">
            @csrf
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de mural:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group m-0">
                                <small>Exibir até a data: *</small>
                                <input type="date" name="date" value="{{ old('date') }}" maxlength="100"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" style="width: 100%;"
                                    placeholder="Descreva aqui as informaçãos do mural de recados.">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
