...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.contracts.store') }}" autocomplete="off" onsubmit="return mySubmit()">
            @csrf
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" style="width: 100%;"
                                    placeholder="Descreva aqui as informaçãos do contrato.">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
