...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.multiplequestions.store') }}" autocomplete="off" onsubmit="return mySubmit()" autocomplete="off">
            @csrf
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de questão multipla:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group m-0">
                                ...
                                <input type="number" name="gabarito" value="{{ old('gabarito') }}"  max="4" min="1" class="form-control @error('gabarito') is-invalid @enderror">
                                @error('gabarito')
                                    <small class="text-red line-height">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                ...
                                <textarea name="response_one" class="form-control @error('response_one') is-invalid @enderror" style="width: 100%;"
                                    placeholder="Descreva aqui a primeira resposta da pergunta para escolha do aluno.">{{ old('response_one') }}</textarea>
                                @error('response_one')
                                    <small class="text-red">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                ...
                                <textarea name="response_two" class="form-control @error('response_two') is-invalid @enderror" style="width: 100%;"
                                    placeholder="Descreva aqui a segunda resposta da pergunta para escolha do aluno.">{{ old('response_two') }}</textarea>
                                @error('response_two')
                                    <small class="text-red">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                ...
                                <textarea name="response_tree" class="form-control @error('response_tree') is-invalid @enderror" style="width: 100%;"
                                    placeholder="Descreva aqui a terceira resposta da pergunta para escolha do aluno.">{{ old('response_tree') }}</textarea>
                                @error('response_tree')
                                    <small class="text-red">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                ...
                                <textarea name="response_four" class="form-control @error('response_four') is-invalid @enderror" style="width: 100%;"
                                    placeholder="Descreva aqui a quarta resposta da pergunta para escolha do aluno.">{{ old('response_four') }}</textarea>
                                @error('response_four')
                                    <small class="text-red">{{ $message }}</small>
                                @enderror
                            </div>
