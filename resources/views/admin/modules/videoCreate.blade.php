...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.modules.videoStore') }}" enctype="multipart/form-data" autocomplete="off">
            @csrf
            <input type="hidden" name="category" value="movie" />
            <input type="hidden" name="subject_id" value="{{ $subject->id }}" />
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de vídeo da disciplina: <strong>{{ $subject->title }}</strong></h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group m-0">
                                <small>Link para o vídeo: *</small>
