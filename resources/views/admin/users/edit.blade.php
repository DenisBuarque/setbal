...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.user.update', ['id' => $user->id]) }}" enctype="multipart/form-data" onsubmit="return mySubmit()">
            @csrf
            @method('PUT')
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário edição de usuário do sistema:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-9">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="phone" value="{{ $user->phone ?? old('phone') }}" placeholder="82 9xxxx-xxxx"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                <small>Cep:</small>
                                <input type="text" name="zip_code" id="cep" value="{{ $user->zip_code ?? old('zip_code') }}"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group m-0">
                                <small>Bairro:</small>
                                <input type="text" name="district" id="district" value="{{ $user->district ?? old('district') }}"
