        ...
        <form method="POST" action="{{ route('admin.modules.store') }}" autocomplete="off">
            ...
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de modulo da disciplina: <strong>{{ $subject->title }}</strong></h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                @enderror
                                <textarea name="description" class="form-control  @error('title') is-invalid @enderror" style="width: 100%;" placeholder="Digite informações sobre o modulo.">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
