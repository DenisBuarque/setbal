...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.forums.index') }}" class="btn btn-md btn-info" title="Adicionar novo registro">
...
@section('content')
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('admin.forums.update',['id' => $forum->id]) }}" autocomplete="off" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-0">
                                <small>Título: *</small>
                                <input type="text" name="title" value="{{ $forum->title ?? old('title') }}" maxlength="100"
