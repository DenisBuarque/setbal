...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{route('admin.polos.update',['id' => $polo->id])}}" onsubmit="return mySubmit()" autocomplete="off">
            @csrf
            @method('PUT')
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de edição polo de ensino:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group m-0">
                                <small>Cidade polo de ensino: *</small>
                                <input type="text" name="title" value="{{ $polo->title ?? old('title') }}" maxlength="100" class="form-control @error('title') is-invalid @enderror">
                                @error('title')
                        ...
                        <div class="col-md-3">
                            <div class="form-group m-0">
                                <small>e-Mail: *</small>
                                <input type="email" name="email" value="{{ $polo->email ?? old('email') }}" maxlength="100" class="form-control @error('email') is-invalid @enderror">
                            </div>
                            @error('email')
                                <small class="text-red line-height">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="col-sm-2">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="zip_code" 
                                    value="{{ $polo->zip_code ?? old('zip_code') }}"
                                    onkeypress="mascara(this, '#####-###')" 
                                    onblur="pesquisacep(this.value);"
                                    maxlength="9" class="form-control @error('phone') is-invalid @enderror">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group m-0">
                                <small>Endereço:</small>
                                <input type="text" name="address" id="address" value="{{ $polo->address ?? old('address') }}"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-0">
                                <small>Cidade: *</small>
                                <input type="text" name="city" id="city" value="{{ $polo->city ?? old('city') }}"
                        ...
                        <div class="col-sm-1">
                            <div class="form-group m-0">
                                <small>Estado: *</small>
                                <input type="text" name="state" id="state" value="{{ $polo->state ?? old('state') }}"
