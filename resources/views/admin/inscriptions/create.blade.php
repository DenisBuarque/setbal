...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.inscriptions.store') }}" onsubmit="return mySubmit()" autocomplete="off">
            @csrf
            <div class="card card-info" style="max-width: 500px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário cadastro de inscrição de aluno:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
